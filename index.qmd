...
- Can we simplify tested interface definitions in a package?
- There are quite a few packages trying this from different angles
...
- it may be tied to an abstract type, or not (`AbstractArray` vs Tables.jl)
...
Illustrated with a simplified `AbstractSet` interface
...
- BaseInterfaces.jl is partly written
  - But many base interfaces are not documented!
